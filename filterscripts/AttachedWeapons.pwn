...
public OnFilterScriptInit(){
	print("Weapon attachment filterscript loaded successfully.");
	return true;
}
...
public OnPlayerUpdate(playerid){
	// Only run this logic every 113 ticks
	if (GetTickCount() - armedbody_pTick[playerid] > 113) {
		new weaponid[13], weaponammo[13], pArmedWeapon = GetPlayerWeapon(playerid);
